...
fun new_settings(
    ...
    assert!(haneul::protocol_config::is_feature_enabled("enable_allowances"), ENotEnabled);
...
public fun new_withdrawal_for_testing<T: store>(
    ...
    AllowanceWithdrawal {
        allowance,
        is_sponsor: false,
        inner: haneul::funds_accumulator::create_withdrawal<T>(funder, amount),
    }
}
