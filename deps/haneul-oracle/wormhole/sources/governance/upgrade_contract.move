...
module wormhole::upgrade_contract {
    ...
    use haneul::package::{UpgradeReceipt, UpgradeTicket};
    ...
    /// a contract upgrade VAA. This governance message is only relevant for Haneul
    /// because a contract upgrade is only relevant to one particular network
    /// (in this case Haneul), whose build digest is encoded in this message.
    public fun authorize_upgrade(
        ...
        // upgrades are protected by the Haneul VM, enforcing the latest package
    ...
    public fun commit_upgrade(
        ...
        haneul::event::emit(ContractUpgraded { old_contract, new_contract });
    }
