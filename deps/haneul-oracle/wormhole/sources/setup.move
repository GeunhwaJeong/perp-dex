...
module wormhole::setup {
    ...
    ///
    /// With the new Move package management system (Haneul 1.63+), packages no
    ...
    /// 1. `haneul::package::test_publish` creates an UpgradeCap with the given
    ///    package ID
    ...
    public fun init_test_only(ctx: &mut TxContext) {
        ...
        transfer::public_transfer(
            haneul::package::test_publish(object::id_from_address(TEST_PACKAGE_ADDR), ctx),
