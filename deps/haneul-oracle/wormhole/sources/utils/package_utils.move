...
module wormhole::package_utils {
    ...
    use haneul::dynamic_field::{Self as field};
    use haneul::object::{Self, ID, UID};
    use haneul::package::{Self, UpgradeCap, UpgradeTicket, UpgradeReceipt};
    ...
    /// Helper for `haneul::package::authorize_upgrade` to modify pending package
    ...
    /// Helper for `haneul::package::commit_upgrade` to modify pending package info
