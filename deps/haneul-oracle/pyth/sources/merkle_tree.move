...
module pyth::merkle_tree {
    ...
    // The Haneul Move stdlb insert function shifts v[i] and subsequent elements to the right.
    // We don't want this behavior, so we define our own set_element function that instead replaces the ith element.
    // Reference: https://github.com/MystenLabs/haneul/blob/main/crates/haneul-framework/packages/move-stdlib/sources/vector.move
