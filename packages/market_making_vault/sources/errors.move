...
public(package) fun withdraw_request_already_exists(): u64 {
    EWithdrawRequestAlreadyExists
}

public(package) fun withdraw_request_does_not_exist(): u64 {
    EWithdrawRequestDoesNotExist
}
